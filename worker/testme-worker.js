 ...
 *   POST /auth/register .. /auth/reset-password, /data/save, /data/load
 * GET  /version — בדיקה מהירה בדפדפן שהפריסה בפועל תואמת את מה שהודבק
 */
...
אם מופיע לחץ דם בדוח, כתוב אותו תמיד כזוג ערכים בפורמט "לחץ דם 120/80" (סיסטולי/דיאסטולי יחד עם לוכסן, ללא יחידה) — לעולם לא כשתי שורות נפרדות.
...
אם מדובר בלחץ דם, החזר בפורמט "לחץ דם 120/80" (סיסטולי/דיאסטולי עם לוכסן).
...
2. קשרים אפשריים בין בדיקות שונות שנראים יחד באותם תאריכים או במגמה דומה (למשל שינויים מקבילים בפרופיל שומנים, בתפקודי כליה/כבד, בלחץ הדם, או בין בדיקות שקשורות קלינית).
